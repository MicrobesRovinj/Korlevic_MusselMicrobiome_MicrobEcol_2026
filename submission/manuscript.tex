...
\caption{The observed number of OTUs, Chao1, ACE, exponential of the Shannon diversity index, and Inverse Simpson diversity index of microbial communities from different environments and sites. Groups that do not share a letter are significantly different (\emph{p} \textless{} 0.05)}\label{fig:alpha}
\end{figure}
...
\caption{Taxonomic classification and average relative contribution of the most abundant (\qty{>=3}{\percent}) bacterial and archaeal sequences in different sampled environments and at each site. NR--No Relative (sequences without known relatives)}\label{fig:taxonomy-environments-sites}
\end{figure}
...
\bibitem[\citeproctext]{ref-Orlic2025b}
\CSLLeftMargin{104. }%
\CSLRightInline{Orlić K (2025) Sezonska dinamika, raznolikost i antibiotska rezistencija bakterija roda {\emph{Vibrio}} u akvakulturi školjkaša istočnog Jadrana. Doctoral Thesis, University of Zagreb}

\bibitem[\citeproctext]{ref-Stauder2010}
\CSLLeftMargin{105. }%
\CSLRightInline{Stauder M, Vezzulli L, Pezzati E, et al (2010) Temperature affects {{\emph{Vibrio}}}{{\emph{ cholerae}}} {O1 El Tor} persistence in the aquatic environment via an enhanced expression of {GbpA} and {MSHA} adhesins. Environ Microbiol Rep 2:140--144. \url{https://doi.org/10.1111/j.1758-2229.2009.00121.x}}
